...
item = cf.data_load('c:\Users\seint\pythondata\python_basic\01_basic\item.json') 
...
while True:
    ...
    if menu == '1':
        ...
        cf.data_save('c:\Users\seint\pythondata\python_basic\01_basic\item.json', item)
        break
    else:
